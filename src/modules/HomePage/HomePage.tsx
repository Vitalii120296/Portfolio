...
export const HomePage = () => {
  return (
    <div className={s.home_page}>
      ...
      <ul>
        <li>Мої проєкти: приклади реальних задач, які я вирішував — від гри до онлайн-магазину</li>
        <li>Про мене: хто я, які навички маю, мій підхід до роботи</li>
        <li>Контакти: де мене знайти, якщо хочете співпрацювати або просто поспілкуватися</li>
      </ul>
      <p>
